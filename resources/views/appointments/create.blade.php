...
<div class="card shadow">
          ...
          @if($errors->any())
            ...
            @endforeach
          @endif
            <form action="{{url('/resevarcitas')}}" method="POST">
            @csrf
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input id="date" name="scheduled_date" class="form-control datepicker" placeholder="Seleccione fecha" type="text" value="{{date('Y-m-d')}}" 
                ...
                <div class="form-group">
                  ...
                  <textarea name="description" id="description" type="text" class="form-control" rows="5" placeholder="Describa los sistomas" required></textarea>
                </div>
