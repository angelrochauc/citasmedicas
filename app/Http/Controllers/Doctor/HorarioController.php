    ...
    public function store(Request $request){
        ...
        for($i=0;$i<7; ++$i){
            if(  $morning_start[$i] >  $morning_end[$i]){
                $errors []= 'Inconsistencia en el turno de la mañana del dia '.$this->days[$i] .'.';
            }
            if(  $afternoon_start[$i] >  $afternoon_end[$i]){
                $errors []= 'Inconsistencia en el turno de la tarde del dia '.$this->days[$i] .'.';
            }
        ...
        $notification = 'Cambios se guardaron correctamente';
